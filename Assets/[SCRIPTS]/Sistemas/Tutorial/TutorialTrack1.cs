...
public class TutorialTrack1 : MonoBehaviour
{
    ...
    {
        "HOLA AMIG@  BIENVENIDO AL TUTORIAL :) ",
        "USAR <b>W A S D</b> PARA CONTROLAR EL VEHICULO",
        "PRESIONA <b>ESPACIO</b> PARA DERRAPAR",
        "EVITA CONOS Y CHARCOS DE ACEITE PARA NO PERDER PUNTOS",
        "SI LOGRAS EVITAR LOS OBSTACULOS GANARAS PUNTOS",
        "HAZ CLICK IZQUIERDO PARA SEGUIR EL RITMO DE LA MUSICA",
        "SI ACIERTAS EL RITMO EN LA BARRA INFERIOR IRAS MAS RAPIDO",
        "MANTEN EL RITMO PARA GANAR PUNTOS",
